...
@patch("citekey_service.random.choice", return_value="Best")
...
@patch("citekey_service.random.choice", return_value="Molecular")
...
@patch("citekey_service.random.choice", return_value="Analysis")
